package com.hdzx.tenement.component;
...
/**
 * Created by anchendong on 15/7/16.
 */
...
public class SwitchView extends View {
    ...
    /**
     * it is String that display to user on switch on state
     */
    private String onText = "abc";
...
//        paint.setColor(isOn ? 0xff4bd763 : 0xffe3e3e3);
        //开启颜色，关闭颜色
        paint.setColor(isOn ? 0xffef6e5a : 0xffe3e3e3);
...
//        paint.setColor(isOn ? 0xff4ada60 : 0xffbfbfbf);
        paint.setColor(isOn ? 0xffef6e5a : 0xffbfbfbf);
        canvas.drawPath(bPath, paint);
        canvas.restore();
        ...
        if (isOn && onText != null) {
            ...
            paint.setColor(0xffffffff);
            canvas.drawText(onText, 10, sCenterY+2, paint);
        }
