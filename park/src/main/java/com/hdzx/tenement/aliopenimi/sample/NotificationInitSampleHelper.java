...
public class NotificationInitSampleHelper extends IMNotification{
	...
	public static void init(){
    	YWLog.i("NotificationInitSampleHelper", "NotificationInitSampleHelper---init");
		YWIMKit imKit = LoginSampleHelper.getInstance().getIMKit();
		if (imKit != null){
			Log.v("NotificationInitSampleHelper", "关闭通知栏提示");
			imKit.setEnableNotification(false);//开启通知栏提示
