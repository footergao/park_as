...
public class ProductDetailActivity extends Activity implements IContentReportor {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		poster_url = intent.getStringExtra("poster");
...
//					http://192.168.0.48/leimingtech-front/shiro-cas?ticket=ST-47-Dx7FygYGbqbtuIwxPcS7-cas01.example.org&rtnurl=http://192.168.0.48/leimingtech-front/m/goods/goodsdetail?id=197
	                String service = UserSession.getInstance().getFrontUrl() + path + "?" + "ticket=" + st + "&rtnurl=" + poster_url;
					...
					Log.v("gl", "url==" + WebViewUtil.formateString(service));
