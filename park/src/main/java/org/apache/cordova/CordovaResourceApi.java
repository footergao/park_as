...
//                Log.d("IceCream", "uri = URI_TYPE_FILE");
            ...
            case URI_TYPE_ASSET: {
                ...
                Log.d("IceCream", "uri = URI_TYPE_ASSET");
                return new OpenForReadResult(uri, inputStream, mimeType, length, assetFd);
            }
            case URI_TYPE_CONTENT:
            	Log.d("IceCream", "uri = URI_TYPE_CONTENT");
            case URI_TYPE_RESOURCE: {
...
//                Log.d("IceCream", "uri = URI_TYPE_RESOURCE");
                return new OpenForReadResult(uri, inputStream, mimeType, length, assetFd);
            }
            case URI_TYPE_DATA: {
...
//                Log.d("IceCream", "uri = URI_TYPE_DATA");
                return ret;
            }
            case URI_TYPE_HTTP:
//            	Log.d("IceCream", "uri = URI_TYPE_HTTP");
            case URI_TYPE_HTTPS: {
//            	Log.d("IceCream", "uri = URI_TYPE_HTTPS");
                HttpURLConnection conn = (HttpURLConnection)new URL(uri.toString()).openConnection();
...
//        Log.i("IceCream", "uri = FileNotFoundException");
